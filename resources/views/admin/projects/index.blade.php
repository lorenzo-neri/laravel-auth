...
@section('content')
    <div class="container">
        ...
        <a style="width: 75px; aspect-ratio:1/1" class="btn btn-success d-flex align-items-center justify-content-center rounded-circle position-fixed bottom-0 end-0 m-4" href="{{ route('admin.projects.create') }}"><i class="fa-solid fa-plus fa-xl"></i></a>
                ...
                <tbody>
                    @forelse ($projects as $project)
                        <tr>
                            ...
                            <td class="align-middle">link github</td>
                            <td class="align-middle">link web</td>

                            <td class="align-middle">{{ $project->tech }}</td>
                          
                            {{-- SHOW --}}
                            <td class="align-middle text-center">
                                <a class="btn btn-primary" href="{{ route('admin.projects.show', $project->slug) }}"><i class="fa-solid fa-magnifying-glass"></i></a>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      <div class="modal-header bg-danger text-white justify-content-center">
                                        <h5 class="modal-title text-uppercase" id="modalTitleId-{{$project->id}}">Attenzione!</h5>
                                      </div>
                                      <div class="modal-body fs-5">
                                        Il progetto <strong>{{$project->id}}</strong> - <strong>{{$project->title}}</strong> sta per essere eliminato!
                                      </div>
